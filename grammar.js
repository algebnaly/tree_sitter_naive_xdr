...
module.exports = grammar({
  ...
  rules: {
    ...
    proc_return: ($) => choice($.keyword_void, $.type_specifier),
    proc_firstarg: ($) => choice($.keyword_void, $.type_specifier),
    definition: ($) => choice($.type_def, $.constant_def, $.program_def),
